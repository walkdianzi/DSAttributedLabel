...
- (void)attributedTextDidChange {
  ...
  /*intrinsicContentSize，也就是控件的内置大小,可以通过invalidateIntrinsicContentSize方法来在下次UI规划事件中重新计算intrinsicContentSize*/
...
- (void)setLineSpace:(CGFloat)lineSpace{
    [self.mutableAttributedString setLineSpace:lineSpace];
